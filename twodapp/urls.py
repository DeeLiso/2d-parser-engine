...
urlpatterns = [
    ...
    path('api/pending_submissions', views.api_pending_submissions, name='api_pending_submissions'),
    path('api/approve_submission', views.api_approve_submission, name='api_approve_submission'),
    path('api/reject_submission', views.api_reject_submission, name='api_reject_submission'),
    path('api/player_notifications', views.api_player_notifications, name='api_player_notifications'),
